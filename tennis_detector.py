...
class TennisCourtDetector:
    ...
    def apply_perspective_transform(self, image, src_corners, output_size=(1097, 2377)):
        ...
        # CPU'ya geri döndür (görselleştirme ve kaydetme için genellikle numpy gerekir)
        # Ancak pipeline içinde kalacaksa UMat olarak kalabilir.
        # Şimdilik çağıran fonksiyonun handle etmesi için UMat döndürelim mi?
        # process_video_frame içinde çizim yapılıyor, o yüzden numpy'a çevirmek daha güvenli şimdilik.
        # Amaç hız ise UMat kalmalı ama çizim fonksiyonları UMat destekliyor mu? Evet çoğu destekler.
        # Fakat numpy array isteyen yerler patlayabilir.
        # Güvenli olması için şimdilik burada .get() yapalım, sonra optimize ederiz.
